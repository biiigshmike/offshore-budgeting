...
struct MarinaMetricContractRegistry {
    ...
    private static func expandedContracts() -> [MarinaMetricContract] {
        [
            catalog(.periodOverview, seed: "Give me a budget overview for this month.", formula: "periodOverview", subjects: [.plannedExpenses, .variableExpenses, .budgets], operations: [.lookupDetails], sources: ["Budget", "PlannedExpense", "VariableExpense", "Category"], basis: .homeSpend, date: "Selected period, defaulting to the current month; named budgets use their inclusive period through the budget summary contract.", never: ["Do not use owned/budget-impact spend unless requested.", "Do not omit planned versus variable evidence."], shape: .summaryCard, status: .executable, missing: "Executable through MarinaSemanticInterpretationContract.periodOverview and HomeQueryMetric.overview.", fixture: "Planned and variable totals differ and both must be visible."),
