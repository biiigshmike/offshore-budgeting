...
struct MarinaEntityCatalog: Codable, Equatable, Sendable {
    ...
    private static func makeDescriptors() -> [MarinaEntityDescriptor] {
        [
            ...
            descriptor("AllocationAccount", lookup: .reconciliationAccount, display: ["name", "hexColor"], derivedAmounts: ["balance"], dates: ["archivedAt"], scope: "workspace", relationships: ["allocations", "settlements"], searchable: true, queryable: true, aggregatable: true, target: true, relationship: true, derived: true, supported: ["lookupDetails", "balance", "total", "average", "rank", "compare", "groupedBreakdown", "allocatedSpend"], missing: ["accountBalanceRoute"], unsupported: ["savingsTreatment"]),
