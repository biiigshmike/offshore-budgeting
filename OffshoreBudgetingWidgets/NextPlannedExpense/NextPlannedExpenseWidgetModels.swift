        ...
        NextPlannedExpenseWidgetSnapshot(
            ...
            items: [
                .init(
                    ...
                    cardThemeToken: WidgetCardVisualTheme.ruby.rawValue,
                    cardEffectToken: WidgetCardVisualEffect.plastic.rawValue,
                ...
                .init(
                    ...
                    cardName: "Bills Card",
                    cardThemeToken: WidgetCardVisualTheme.aqua.rawValue,
                    cardEffectToken: WidgetCardVisualEffect.plastic.rawValue,
        ...
        NextPlannedExpenseWidgetSnapshot(
            ...
            items: [
                ...
                .init(
                    ...
                    cardName: "Apple Card",
                    cardThemeToken: WidgetCardVisualTheme.periwinkle.rawValue,
                    cardEffectToken: WidgetCardVisualEffect.plastic.rawValue,
                    expenseDate: Calendar.current.date(from: DateComponents(year: 2026, month: 3, day: 14)) ?? .now,
                    plannedAmount: 37.99,
                    actualAmount: 37.99
